...
security, and Super Stream changes must update the canonical adapter's
[specification decision register](adapters/rabbitmq/docs/specification-decisions.md).
