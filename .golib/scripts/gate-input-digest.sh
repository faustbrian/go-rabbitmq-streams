    ...
    while IFS= read -r service; do
        ...
        case "${service}" in
            ...
            rabbitstream-standalone)
                append_file "${root}/rabbitmq/integration/enabled_plugins"
                append_file "${root}/rabbitmq/integration/standalone-compose.yaml"
                append_file "${root}/rabbitmq/integration/standalone-setup.sh"
                append_file "${root}/rabbitmq/integration/standalone.conf"
                continue
                ;;
            rabbitstream)
                append_file "${root}/rabbitmq/integration/compose.yaml"
                append_file "${root}/rabbitmq/integration/enabled_plugins"
                append_file "${root}/rabbitmq/integration/rabbit1.conf"
                append_file "${root}/rabbitmq/integration/rabbit2.conf"
                append_file "${root}/rabbitmq/integration/rabbit3.conf"
                append_file "${root}/rabbitmq/integration/setup.sh"
                append_file "${root}/rabbitmq/integration/standalone-compose.yaml"
                append_file "${root}/rabbitmq/integration/standalone-setup.sh"
                append_file "${root}/rabbitmq/integration/standalone.conf"
                append_file "${root}/rabbitmq/integration/tls-compose.yaml"
                append_file "${root}/rabbitmq/integration/tls-rabbitmq.conf"
                append_file "${root}/rabbitmq/integration/tls-setup.sh"
                continue
                ;;
            opensearch)
