...
run_gate() {
    ...
    case "${selected}" in
        ...
        licenses)
            ...
            if [[ "${module_path}" != "github.com/faustbrian/go-rabbitmq-streams" &&
                "${module_path}" != github.com/faustbrian/go-rabbitmq-streams/* ]]; then
            ...
            run_go_tool \
                ...
                go-licenses \
                check ./... \
                --ignore "github.com/faustbrian/go-rabbitmq-streams"
            ;;
        sbom)
            applicable security || { skip_not_applicable security; return; }
